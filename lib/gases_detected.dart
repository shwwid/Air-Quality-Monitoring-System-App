...
class GasesDetected extends StatefulWidget {
  const GasesDetected({super.key});

  @override
  State<GasesDetected> createState() => _GasesDetectedState();
}

class _GasesDetectedState extends State<GasesDetected> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          const double n02Threshold = 15.0;
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _gasSlider('NH₃', 'Ammonia', _sensorData!.nh3),
                              _gasSlider(
                                'NO₂',
                                'Nitrogen Dioxide',
                                _sensorData!.no2,
                              ),
                              // Add more gases below if needed
                              //_gasSlider('CH₄', 'Methane', _sensorData!.ch4),
                              //_gasSlider('LPG', 'Liquefied Petroleum Gas', _sensorData!.lpg),
                            ],
                          ),
                        ),
                      ),
